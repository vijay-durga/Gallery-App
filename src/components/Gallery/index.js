    ...
    return (
      <div>
        <div className="bg-cont">
          <div>
            <img src={imageUrl} alt={imageAltText} className="image-size" />
          </div>
          <h1>Nature Photography</h1>
          <p>Nature Photography by Rahul</p>
        </div>
        <div>
          <ul className="thumbnail-li">
            {imagesList.map(eachImage => (
              <ThumbnailItem
                key={eachImage.id}
                eachImage={eachImage}
                onSelectingImage={this.onClickingImageThumbnail}
